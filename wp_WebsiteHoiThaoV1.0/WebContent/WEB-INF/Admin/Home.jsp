...
<head>
    ...
    <!-- custom design  -->
    <link rel="stylesheet" href="./private/assets/admin/privateCss/privateCss.css">
        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-xs-6 col-sm-4 col-md-4 col-md-offset-4 col-xs-offset-0 aline-t">
                    ...
                    <div class="row">
                        <div class="col-xs-12 col-md-6 col-md-offset-8 col-xs-offset-0">
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="myNavbar">
                <ul class="nav navbar-nav">
                    ...
                    <li><a href="${pageContext.request.contextPath}/Dashboard">Trang quản lý</a></li>
                </ul>
                <% if(session.getAttribute("Login")==null) { %>
                	<ul class="nav navbar-nav navbar-right">
                    	<li><a href="#"><span class="fa fa-sign-in"></span> Đăng kí</a></li>
                    	<li><a href="#"><span class="fa fa-sign-out"></span> Đăng Nhập</a></li>
                	</ul>
               <% } else { %>
               		<ul class="nav navbar-nav navbar-right">
                    	<li><a id="user-name" href="#"> <%=session.getAttribute("Login") %> </a></li>
                	</ul>
                <% } %>
            </div>
        </div>
        ...
        <div class="row" >
            ...
            <div class="col-md-4 col-sm-4 col-xs-12" >
                <div class="panel panel-primary">
                    ...
                    <div class="panel-body cuspanel-body">
                        <div class="row" >
            ...
            <div class="body-activi">
                <div class="row" style="margin: 0px;">
                    <div class="col-md-4 col-sm-4 col-xs-4">
                        <div class="captiactivi">
                            <h2>Chủ đề nổi bật trong tháng</h2>
                            <hr>
