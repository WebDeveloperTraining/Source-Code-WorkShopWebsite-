    ...
    <div class="row">
     ...
     <div class="top-navigation">
      <ul class="navbar-nav">
        ...
        <li class="dropdown">
          <a class="dropdown-toggle"  href="#" data-toggle="dropdown"><img style="height: 20px;width: 20px; padding: 0 0 0px" src="./public/images/1.jpg" class="img-circle" alt="">
            Công Trịnh Văn
    ...
    <div class="nav-side-menu">
      <div class="">
        ...
        <div class="img-info hidesmall">
          <div class="pic">
            <img src="./public/images/1.jpg" class="img-circle" alt="Cinque Terre" width="50" height="50"> Xin chào, 
          </div>
          <div class="info">
        ...
        <form action="ManageUser" method="get">
          <div class="col-lg-4 col-md-4 colxs-6 widget-holder">
            <div class="panel panel-default">
              ...
              <div class="panel-footer modycol">
                <div style="float: right;">
                  <button type="submit" class="btn btn-primary btn-xs" id="manauser1">
                    <i class="fa fa-gears"></i> Đi tới...
                  </button>
                </div>
                <div class="clearfix"></div>
