...
<body >
    ...
    <% String errorMessage=request.getParameter("errorMessage");
    	if("-1".equals(errorMessage)){
    		out.println("<h4 style=\"color: red;\">Đăng nhập thất bại</h4>");
    	}
    %>
        ...
        <div class="wrap-login">
            ...
            <form class="login" action="<%=request.getContextPath()%>/Login" method="post">
                <div class="form-group">
                    ...
                    <input type="text" name="UserName" placeholder="Tên đăng nhập" class="form-control" id="usernamelogin">
                </div>
                <div class="form-group">
                    <label for="password">Mật khẩu *</label>
                    <input type="password" name="Password" placeholder="Mật khẩu" id="passlogin" class="form-control">
                </div>
